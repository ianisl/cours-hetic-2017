...
const p = {
    ...
    agentColorHue: 220 // La couleur dominante est spécifiée à l'aide de la teinte du mode de couleur HSB
};
// ----------
...
let agentColor; // Les autres paramètres de couleur seront mis à jour aléatoirement
...
function initPositionAndColor() {
    ...
    colorMode(HSB, 360, 100, 100); // Pour mettre à jour la couleur aléatoirement en conservant la teinte 'p.agentColorHue' définie dans les paramètres, on crée la nouvelle couleur de l'agent dans l'espace HSB. Les paramètres additionnels étalonnent la plage maximale des valeurs de teinte, saturation et luminosité. Les valeurs '360, 100, 100' correspondent à l'espace HSB tel qu'il est défini dans Photoshop.
    var c = color(p.agentColorHue, random(100), random(100)); // Création de la nouvelle couleur en mode HSB
